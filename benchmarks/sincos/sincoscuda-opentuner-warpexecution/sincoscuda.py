...
# --------------------------------------------------------------------
  def run(self, desired_result, input, limit):
    ...
    if not compiled:
      ...
      # MUDAR AQUI-----------
    run_cmd = 'nvprof --metrics warp_execution_efficiency ./sincosc-cuda'
...
# --------------------------------------------------------------------
  def save_final_config(self, configuration):
    ...
    # MUDAR AQUI-----------
    self.manipulator().save_to_file(configuration.data, 'sincoscuda_final_config_warp-execution'+str(sys.argv[2])+'.json')

...
# --------------------------------------------------------------------
  def run(self, desired_result, input, limit):
    ...
    if not compiled:
      ...
      # MUDAR AQUI-----------
    run_cmd = 'nvprof --metrics ipc ./sincosc-cuda'
...
# --------------------------------------------------------------------
  def get_metric_from_app_output(self, app_output, configuration, kernel, gpuId):
    ...
    arquivo_csv.write("Kernel,gx,gy,gz,bx,by,gpuId,ipc \n")
...
# --------------------------------------------------------------------
  def save_final_config(self, configuration):
    ...
    # MUDAR AQUI-----------
    self.manipulator().save_to_file(configuration.data, 'sincoscuda_final_config_ipc'+str(sys.argv[2])+'.json')

...
# --------------------------------------------------------------------
  def get_metric_from_app_output(self, app_output, configuration, kernel,gpuId):
    ...
    arquivo_csv = open("/home/joao/Documentos/tcc_cuda_opentuner_joao/results/gtx1070/sincos-gld_efficiency-executed-"+str(sys.argv[2])+".csv","a")
    arquivo_csv.write("Kernel,gx,gy,gz,bx,by,bz,gpuId,gld_efficiency \n")

...
class gemmTuner(MeasurementInterface):
	...
	def run(self, desired_result, input, limit):
		...
		run_cmd = 'nvprof --metrics gld_efficiency ./gemm-cuda.exe'
	...
	def get_metric_from_app_output(self, app_output, configuration, kernel):
		...
		arquivo_csv = open("/home/joao/Documentos/tcc_cuda_opentuner_joao/results/gtx1070/gemm-gld_efficiency-"+str(sys.argv[2])+".csv","a")

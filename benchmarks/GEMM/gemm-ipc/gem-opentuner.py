...
class gemmTuner(MeasurementInterface):
	...
	def run(self, desired_result, input, limit):
		...
		run_cmd = 'nvprof --metrics ipc ./gemm-cuda.exe'
	...
	def get_metric_from_app_output(self, app_output, configuration, kernel):
		...
		arquivo_csv = open("/home/projetocuda/Documentos/tcc_cuda_opentuner_joao/results/gtx780/gemm-smefficiency-"+str(sys.argv[2])+".csv","a")

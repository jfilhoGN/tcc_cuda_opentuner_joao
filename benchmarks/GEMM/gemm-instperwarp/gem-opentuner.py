...
class gemmTuner(MeasurementInterface):
	...
	def run(self, desired_result, input, limit):
		...
		run_cmd = 'nvprof --metrics inst_per_warp ./gemm-cuda.exe'
	...
	def get_metric_from_app_output(self, app_output, configuration, kernel, gpuId):
		...
		arquivo_csv = open("/home/joao/Documentos/tcc_cuda_opentuner_joao/results/gtx1070/gemm-instperwarp-"+str(sys.argv[2])+".csv","a")
